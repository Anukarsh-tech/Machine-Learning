...
# Category dictionary
categories = {0: 'palm', 1: 'fist', 2: 'thumbs-up', 3: 'thumbs-down',
              4: 'index-right', 5: 'index-left', 6: 'no-gesture'}


def main():
    html_temp = """
    <div style="background-color:#483D8B;padding:10px;margin-bottom:10px;">
    ...
    st.sidebar.title("Gestures and their Function")
    html_temp6 ="""
<h3 style="color:#f63366 ;text-align:center;"> </h3>
        <ul> 
...
"""
    ...
    """
        ...
        while run:
            ...
            cv2.putText(frame, text1, (10, 120),
                        cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 0, 0), 1)
            cv2.putText(frame, text2, (10, 220),
                        cv2.FONT_HERSHEY_COMPLEX_SMALL, 1, (255, 0, 0), 1)
